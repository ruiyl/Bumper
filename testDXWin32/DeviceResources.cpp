...
void DeviceResources::CreateDeviceIndependentResources()
{
	...
	try {
		...
		//file.open("device.txt", std::ofstream::out | std::ofstream::app);
		//file << e.what() << "\n";
		//file.close();
	}

	//file.open("device.txt", std::ofstream::out | std::ofstream::app);
	//file << "d2dfactory created\n";
	//file.close();
...
void DeviceResources::CreateDeviceResources() 
{
	...
	OutputDebugString(L"created resource\n");
}
